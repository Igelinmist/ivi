...
from ivi.app import create_app
from ivi.database import db
from ivi.settings import DevConfig, ProdConfig
from ivi.user.models import User

CONFIG = ProdConfig if os.environ.get('IVI_ENV') == 'prod' else DevConfig
